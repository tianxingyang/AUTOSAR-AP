...
class Result final {
 public:
  ...
  /// : std::is_constructible<T, Args&&...>::value is true, and the first type of the expanded parameter pack is not T,
  /// and the first type of the expanded parameter pack is not a specialization of Result
  ...
  Result& operator=(const Result& other) { data_ = other.data_; }
